    ...
    <div class="section">
        ...
        <div class="container text-center">
            <h3><a href="informasi.php">Informasi</a></h3>
            ...
            ?>
                ...
                <div class="col-4">
                    ...
                    <div class="thumbnail-box">
                        ...
                        <div class="thumbnail-text" title="<?= $p['judul'] ?>">
                            <?= substr($p['judul'], 0, 50) ?>
                        </div>
                    </div>
                    </a>
    ...
    <div class="section" id="galeri">
        ...
        <div class="container text-center">
            <h3><a href="galeri.php">Galeri</a></h3>
            ...
            ?>
                ...
                <div class="col-4">
                    <a href="detail-galeri.php?=<?= $s['foto'] ?>" class="thumbnail-link">
                    <div class="thumbnail-box">
                        <div class="thumbnail-img" style="background-image: url('uploads/galeri/<?= $s['foto'] ?> ');">
                            
                        </div>
                        <div class="thumbnail-text" title="<?= $s['keterangan'] ?>">
